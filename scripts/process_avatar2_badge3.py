...
files = [
    {
        "src": os.path.join(base_dir, "rich_avatar_02_raw_1772436729534.png"),
        "dest": os.path.join(target_dir, "avatars", "avatar_default_02.png"),
        "size": (64, 64),
        "trans": True
    },
    {
        "src": os.path.join(base_dir, "rich_badge_messenger_raw_1772436875207.png"),
        "dest": os.path.join(target_dir, "badges", "badge_messenger.png"),
        "size": (32, 32),
        "trans": True
    }
]
