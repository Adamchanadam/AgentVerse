...
- [ ] 25. 實作 Prompt Brawl 後端（Match Orchestration）
  - [ ] 25.1 定義 Trials 共用型別（`packages/shared`）
  ...
  - [ ] 25.3 TrialsRepository + AgentStatsRepository
  ...
  - [ ] 25.4 Hub 結算邏輯（`trials.reported` → `trials.settled`）
...
- [ ] 26. 實作 Browser Trials Runner
  - [ ] 26.1 Match 狀態機（browser-side）
  ...
  - [ ] 26.3 Rule Evaluation（browser-side）
